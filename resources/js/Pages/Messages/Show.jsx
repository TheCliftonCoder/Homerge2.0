                        ...
                        <div className="flex flex-1 flex-col bg-white">
                            ...
                            <div className="flex items-center justify-between border-b border-gray-200 bg-white p-4">
                                ...
                                <div className='hidden sm:flex items-center gap-4'>
                                    ...
                                    <Link
                                        href={route('messages.destroy', conversation.id)}
                                        method='delete'
                                        as='button'
                                        className='inline-flex items-center justify-center rounded-xl border border-red-200 hover:border-red-300 hover:bg-red-50 px-3 py-2 text-xs font-bold text-red-600 active:scale-95 transition-all duration-150'
                                    >
                                        Delete Chat
                                    </Link>
                                </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className={`max-w-[70%] rounded-2xl px-4 py-2 shadow-sm ${
                                                ...
                                                <div className={`mt-1 flex items-center justify-end gap-2 text-[10px] ${isMe ? 'text-indigo-100' : 'text-gray-400'}`}>
